/*
 ...
 Source Server         : 10.121.198.146
 Source Server Type    : MySQL
 Source Server Version : 50732
 Source Host           : 10.121.198.146:3306
...
CREATE TABLE `bus_customer`  (
  ...
  `logistics_base_id` int(11) NULL DEFAULT NULL COMMENT '用来关联物流信息',
...
CREATE TABLE `bus_logistics_base`  (
  ...
  `logistics_scope` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `logistics_phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `available` int(11) NULL DEFAULT NULL,
  `logistics_cost` decimal(10, 2) NULL DEFAULT NULL COMMENT '物流单价',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_permission` VALUES (127, 126, 'menu', '物流基础信息管理', NULL, '&#xe716;', '', '', 1, 92, 1);
